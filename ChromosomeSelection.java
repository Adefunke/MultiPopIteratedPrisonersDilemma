...
public class ChromosomeSelection implements Cloneable {
    ...
    protected static int historyGeneLength = 6;
    protected int[] genes;
    ...
    void updateHistory(int myvalue, int competitorValue) {
        ...
        this.historyTemp[1] = this.historyTemp[2];
        this.historyTemp[2] = myvalue;
        this.historyTemp[3] = this.historyTemp[4];
        this.historyTemp[4] = this.historyTemp[5];
        this.historyTemp[5] = competitorValue;
    }
